package com.example.graphql.product.infrastructure.search;
...
@Repository
public class HibernateProductSearchAdapter implements ProductSearchRepository {

    private static final Logger log = LoggerFactory.getLogger(HibernateProductSearchAdapter.class);
    ...
    public HibernateProductSearchAdapter(EntityManager entityManager, 
    ...
    private Map<String, Object> calculateNumericStats(Map<?, Long> dist) {
        ...
        double max = -Double.MAX_VALUE; // Fixed logic here while at it
        double sum = 0;
        long count = 0;
